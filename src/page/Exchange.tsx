    ...
    <div className='h-[calc(100%-50px)] items-center gap-2 overflow-y-auto w-full overflow-x-hidden hiddenScrollBar relative'>
      <div className={`bg-[#046ae2] flex gap-1 px-6 pt-5 pb-10 w-full justify-between items-center ${isModal && 'blur-md opacity-30'}`}>
        <div className='flex gap-2'>
          <img src='/hello.png' className='w-10' loading='lazy' />
      ...
      <div className={`relative rounded-2xl -top-5 w-full flex justify-between pt-5 px-5 gap-2 items-center flex-col bg-[#040404] exchange-content ${isModal && 'blur-md opacity-30'}`}>
        <div className='flex flex-col gap-4 justify-evenly w-full items-center h-full'>
          ...
          <div>
            ...
            <p className='xxs:text-xl text-lg text-[#acacac]'>$Henlo</p>
          </div>
          <div className='w-full'>
            <div className='w-full'>
              {/* <Carousel
                className='carousel-card relative -left-[1%] overflow-visible'
                infiniteLoop={true}
                showArrows={false}
                showIndicators={true}
                showStatus={false}
